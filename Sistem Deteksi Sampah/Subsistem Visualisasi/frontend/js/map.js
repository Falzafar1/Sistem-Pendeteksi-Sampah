...
function renderPinpoints(detections) {
  ...
  detections.forEach(d => {
    totBottle += d.plastic_bottle_count;
    totCan    += d.can_count;
    totLeaf   += d.leaf_pile_area_m2;
    totMixed  += d.mixed_waste_area_m2;
      ...
      <div class="popup-inner">
        ...
        <div class="popup-grid">
          <div class="pg-item pg-bl">
            ...
            <span class="pgv">${d.plastic_bottle_count} pcs</span>
          </div>
          <div class="pg-item pg-pu">
            <span class="pgl">Kaleng</span>
            <span class="pgv">${d.can_count} pcs</span>
          </div>
          <div class="pg-item pg-gr">
            <span class="pgl">Tumpukan Daun</span>
            <span class="pgv">${d.leaf_pile_area_m2} m²</span>
          </div>
          <div class="pg-item pg-am">
            <span class="pgl">Luas Sampah</span>
            <span class="pgv">${d.mixed_waste_area_m2} m²</span>
          </div>
        </div>
